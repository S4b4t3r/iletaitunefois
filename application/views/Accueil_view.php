<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div>
            <div class="h2title"><h2>News - feed</h2></div>
            <br>
            <p>Si vous désirez rester au courant de nos <span>actualités</span>, vous pouvez vous abonner à notre fil <i>(news feed)</i></p>
            <span>[P]</span><a>Ouvrir / S'abonner au feed</a>
        </div>
        <div>
            <div class="h2title"><h2>Kulturpass Bienvenu !</h2></div>
            <br>
            <a>Suivez-nous sur <span>Facebook</span> !</a><span>[P]</span>
        </div>
        <div>
            <div class="h2title"><h2>Jours d'ouverture</h2></div>
            <br>
